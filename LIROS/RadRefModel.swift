...
let radMRIAreas = ["brain", "spine", "neck soft tissue", "extremity", "abdomen", "chest", "sinuses", "orbits", "pelvis"]
let radCTAreas = ["angio brain", "angio abdomen/pelvis with runoff", "brain", "chest", "coronary calcium", "coronary arteries", "abdomen", "sinus", "neck soft tissue", "extremity", "myelogram", "orbits", "facial bones", "temporal bones", "spine", "pelvis", "head", "enterography", "colonography"]
...
let radMRIAbSides = radContrast + ["and pelvis without contrast", "and pelvis with PO&IV contrast", "and pelvis with PO contrast"]
...
let radCTAbSides = radContrast + ["and pelvis without contrast", "and pelvis with contrast", "and pelvis with and without contrast", "and pelvis renal stone protocol"]
