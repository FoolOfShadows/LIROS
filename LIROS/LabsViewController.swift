...
//		resultsArray.append(Labs().processLabDataForPrint(labFields))
//		if let otherLabResults = processOtherLabs(data: [(other1View.stringValue, other1DxCombo.stringValue), (other2View.stringValue, other2DxCombo.stringValue)]) {
//			resultsArray.append(otherLabResults)
//		}
		//Clear the system clipboard
		let pasteBoard = NSPasteboard.general
		pasteBoard.clearContents()
		//Set the system clipboard to the final text
		pasteBoard.setString(resultsArray.joined(separator: "\n"), forType: NSPasteboard.PasteboardType.string)
		
		print(resultsArray.joined(separator: "\n"))
	}
